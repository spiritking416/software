...
namespace INDNC
{
    ...
    internal partial class FormMain : Form
    {
        ...
        public void Initialize()
        {
            ...
            MySqlConnection cn = new MySqlConnection("server=" + "localhost" + ";user id=" + "root" + "password=" + "416520" + ";database=system;charset=gb2312");

            CheckForIllegalCrossThreadCalls = false; //解决线程间的访问限制

            //LineNo、WorkShopNo初始化
            LineNo = 0;
            WorkShopNo = 0;
            string lineindex = global::INDNC.Properties.Settings.Default.LineNo;
            string workshopno = global::INDNC.Properties.Settings.Default.WorkShopNo;
            if(lineindex=="" || workshopno == "")
            {
                lineindex = "1";
                workshopno = "1";
            }
            ...
            try
            {
                if (UInt16.TryParse(lineindex, out LineNo) != true)
                    throw new Exception();
                if (UInt16.TryParse(workshopno, out WorkShopNo) != true)
                    throw new Exception();
            }
            catch (Exception)
            {
        ...
        private void buttonSetting_Click(object sender, EventArgs e)
        {
            ...
            controlsetting.btnLineParaSettingClick += new btnOkClickEventHander(ControlLineParaSettingclick);
        }
        ...
        private void ControlLineParaSettingclick(object send, System.EventArgs e)
        {
